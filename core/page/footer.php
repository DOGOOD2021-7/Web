<footer id="footer" class="px-6 py-2 bg-gray-800 text-gray-100">
    <div class="flex flex-col justify-between items-center container mx-auto md:flex-row"><a href="#"
            class="text-2xl font-bold">DOGOOD</a>
        <p class="mt-2 md:mt-0">2021 Team Number. 7 <span class="font-bold">Hackathon</span>
...
<script src="../../../lib/js/jquery.ajax-cross-origin.min.js"></script>
